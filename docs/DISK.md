...
That means the gradient, and any information about the Tensor in the computation graph (see [here](COMPUTATION_GRAPH.md) for more on that), and generally and extra metadata are not retained.
